/*global canvasutils canvasteroids controller sprites geometry renderer eventbus drawable ui interactive*/
...
*/
    ...
    Ext.define('canvasteroids.Game', {
        ...
        requires: ['eventbus.EventBus', 'canvasutils.CanvasUtils', 'sprites.Rock', 'sprites.Ship', 'sprites.ShipFragment', 'sprites.Bullet', 'drawable.Layer', 'controller.Keyboard', 'ui.Button', 'interactive.ClickableLayer'],
        ...
        makeRocks: function () {
            ...
            for (var r = 0; r < num_rocks; r++) {
                ...
                //do not clobber ship
                if (this.ship && this.state === this.START_LEVEL && rock.intersects(this.gameLayer.ctx, this.ship)) {
                    num_rocks++;
                    continue;
                }
        ...
        bulletHitRock: function (rock) {
            ...
            for (var i = 0; i < this.bullets.length; i++) {
                ...
                if (rock.containsPoint(ctx, bullet.x, bullet.y)) {
                    this.removeBullet(bullet);
                    return true;
                }
            }
        ...
        hitRock: function (ship, rock) {
            ...
            if (Math.abs(ship.x - rock.x) > range || Math.abs(ship.y - rock.y) > range) {
                ...
                return ship.intersects(this.gameLayer.ctx, rock);
            }
        },
