...
*/
    ...
    Ext.define('canvasteroids.Game', {
        ...
        requires: ['canvasutils.CanvasUtils', 'canvasteroids.Rock', 'canvasteroids.Ship', 'renderer.CanvasRenderer', 'geometry.Plane', 'controller.Keyboard'],
        ...
        constructor: function (conf) {
            ...
            this.keyboard = Ext.create('controller.Keyboard', {
                context: this,
